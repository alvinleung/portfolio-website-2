...
<FullImage
  ...
  alt="UI Interaction contribution"
/>

##### Experience Design

-> Managing and deveolping user interface for complex use cases that involve multiple personas.
...
-> Based on identified use case, I bring fourth the idea of utilising timeline as a visual way to unify the working experience leading to a better mental model. With consideration of the user journey, I also suggested the use of temporary popup cards in the home screen for quick access. Which interaction pattern can also be found in the messaging UI for consistency.
...
<FullImage
  ...
  alt="Empathy mapping in the early discovery session"
  caption="Empathy mapping in the early discovery session"
/>

<FullImage
  src="/img/helpmate/whiteboard-flow-1.jpg"
  alt="Sketching out user flow"
  caption="Sketching out user flow"
/>
...
-- The prototype was tested on 5 participants. Collected insights were then feed back into the design process.
