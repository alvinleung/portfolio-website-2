...
-> With consideration of the user journey, I suggested the use of temporary popup cards in the home screen for quick access. Which interaction pattern is also used in the messaging UI for consistency. Based on identified use case, I also bring fourth the idea of utilising timeline as a visual way to unify the working experience, improving the visibility of system status.
