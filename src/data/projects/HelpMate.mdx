...
tag: "featured"
weight: 1
tagline: App concept of a community-based task finding platform for household chores.
cover: /img/helpmate-cover.webp
description: App concept of a community-based task finding platform for household chores.
---
...
<ProjectInfo>
  <ProjectInfoItem fieldName="My Role" value="UI/UX Design, Illustration" />
...
-- We were assigned to find a topic based on a selection of areas of interest. With a little bit of looking around on the internet, the team settled on Shared Economy as we think that would provide us unique yet practical UI design challenges to improve our skills.
...
-- With its emphasis on the social relationship, HelpMate fills the void between Craiglist and Taskrabbit.

From our research, we found that existing solutions like Craiglist allow more causal exchange, but it does not provide enough reliability and security for its user. While TaskRabbit, which aimed at professional/semi-professional taskers, might exclude helpers who couldn't be as committed and experienced.

<FullImage
  src="/img/helpmate/competitor-analysis.webp"
...
<FullImage src="/img/helpmate/persona-joy.webp" alt="Joy's Persona" />
<FullImage src="/img/helpmate/persona-jordan.webp" alt="Jordan's Persona" />

---

## 06 Design Principles

-- To support the unique use cases of target users, a set of design principles was established to drive the design process.

<FullImage src="/img/helpmate/design-principles.webp" alt="Joy's Persona" />
...
<FullImage
  src="/img/helpmate/feature-reschedule-1.webp"
...
<FullImage
  src="/img/helpmate/feature-cancel-1.webp"
...
<FullImage
  src="/img/helpmate/feature-appeal.webp"
...
<FullImage
  src="/img/helpmate/feature-urgent.webp"
...
<FullImage
  src="/img/helpmate/feature-verification.webp"
...
## 08 Usability Testing and Fixes
...
-> The uncovered issues were systematically categorised using an affinity diagram and dot voting. By doing so we methodically turn these insights into actionable design items, successfully incorporating the user feedback into the final design.
...
<ComparisonView>
  <ComparisonItem src="/img/helpmate/usability-card-after.webp" label="After" />
  <ComparisonItem
    src="/img/helpmate/usability-card-before.webp"
    label="Before"
  />
</ComparisonView>
...
<ComparisonView>
  <ComparisonItem
    src="/img/helpmate/usability-accept-task-after.webp"
    label="After"
  />
  <ComparisonItem
    src="/img/helpmate/usability-accept-task-before.webp"
    label="Before"
  />
</ComparisonView>
...
<FullImage
  src="/img/helpmate/usability-check-in-card.webp"
...
-> **Fix**: Added an option in the confirmation screen after accepting a task, to allow Clients to indicate whether they want these check-in updates or not.
...
_Note: What highlighted above were a few of the major fixes, this presentation slide deck provide a detailed breakdown and solutions of all the issues we found._

---

## 09 Outcome — The Final User Flows

-- Here is a demonstration of the client & helper experience.
...
-> To find help with chores, the client can create a task under _My Tasks_. Task category and details like location, description, date, amount of helpers are customisable in the task creation modal. After the form is completed, an entry of the task will be added to the community taskboard.
...
-> The client will receive a notification when a Helper sends a task request. They can now chat and confirm the task details under the in-app messaging system which was tailored for the scenario.
...
-> To allow clients to have a peace of mind, they will be informed as the task progress status updates. Some check-in feature might be opted out if the client is present during the task.
...
-> Upon finishing the task, clients and Helpers can leave ratings and reviews for each other. This step is crucial for the HelpMate concept as the user's peer review is the fundamental building block of safety and trust.
