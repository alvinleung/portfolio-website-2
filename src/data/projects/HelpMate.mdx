...
-> Based on identified use case, I bring fourth the idea of utilising timeline as a visual way to unify the working experience so that we can acheive a better mental model. With consideration of the user journey, I also suggested the use of temporary popup cards in the home screen for quick access. Which interaction pattern is also used in the messaging UI for consistency.
