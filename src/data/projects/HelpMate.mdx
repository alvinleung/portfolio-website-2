...
-> Working with other teammates, I help the development and maintenance of the an design system (taking inspiration from apple human interface guidelines and material design) as the app concept grows, balancing consistency with efficiency, ensuring it is logic and visuals are coherent.
