...
-- Here are highlights of my contributions that helped driving the project forward.
...
<ResourceLink url="/HelpMate-User-Testing-Slides.pdf">
  User Testing Slideck (PDF)
</ResourceLink>

_Note: What highlighted above were few of the major fixes that, this presentation slide deck provide detail breakdown and solutions of all the issues we found._
