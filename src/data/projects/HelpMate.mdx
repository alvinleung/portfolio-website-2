...
## 09 Outcome - The UI Experience

<InterfaceDemo url="https://www.sfu.ca/~kkl64/videos/helpmate/1-create-task.mp4" />
...
<InterfaceDemo url="https://www.sfu.ca/~kkl64/videos/helpmate/2-find-task.mp4" />
...
<InterfaceDemo url="https://www.sfu.ca/~kkl64/videos/helpmate/3-receive-request.mp4" />
...
<InterfaceDemo url="https://www.sfu.ca/~kkl64/videos/helpmate/4-check-in.mp4" />

##### Appointment confirmation [CLIENT & HELPER]

-> Before the appointment, the helper will be asked to confirm the arrival time. This is designed to give time for

<InterfaceDemo url="https://www.sfu.ca/~kkl64/videos/helpmate/5-task-done.mp4" />

##### Check in and Payment [CLIENT & HELPER]

-> In order to give the clients a peace of mind, they will be informed as the task progress status updates. Some check in feature might be opted out if the client is present during the task.

<InterfaceDemo url="https://www.sfu.ca/~kkl64/videos/helpmate/6-review.mp4" />

##### [CLIENT & HELPER] Leave a Review
