...
<ListLayout noPadding full label="Major themes in participant's response">
  <ListItem heading="Real life Problem">
    ...
    meaningful, solving real life problem.
  </ListItem>
  ...
  <ListItem heading="Self Development">
    Students who join PIVOT also has a passion for critical thinking ,
    innovation and creativity. Student who join PIVOT wanted to step out of
...
-> The scroll progress indicator highlights the current user position, aiding their navigation in this relatively long scorlling page.
...
-- I created a handover document with detailed specification of different interface components, but because the tight turnaround time, I was ended up heavily involved in the development process as well.
