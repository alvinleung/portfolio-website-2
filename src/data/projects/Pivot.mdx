...
-- We started the project by organising 70 participant applications of the previous year utilising the Affinity Diagram. Working with the Pivot project manager, we then consolidated a persona of the type of student with who we wanted to engage.

<ListLayout noPadding full label="Major themes in participant's response">
  <ListItem heading="Real-life Scenario">
    Students coming back to PIVOT because they thought previous cases are
    meaningful as it involved a real-life business problem.
  </ListItem>
  ...
  <ListItem heading="Self Development">
    ...
    their interested field wanting to develop the skills and build connections
    required for their future endeavours
  </ListItem>
  <ListItem heading="Gateway to More Upscale Competition">
    Some students who are into pivot see it as a gateway to a more upscale
    competition in the future.
  </ListItem>
</ListLayout>

<FullImage src="/img/pivot/persona-alex.webp" alt="Driven Competitor persona" />
...
-- For young and ambitious future business leaders, this rebellious approach celebrates the potential of their fresh perspectives and capabilities by exploring distorted visuals, breaking away from traditional corporate minimalist aesthetic.

<FullImage
  src="/img/pivot/ad-moodboard.webp"
...
<FullImage src="/img/pivot/ad-font.webp" alt="Art direction typography" />

##### Typography

-> To represent the technology-focused competition, the approach utilise medium and bold variants of the IBM plex sans family (depending on scale) as its primary font because of the distinctive mechanical appearance created by its emphasis on sharp angles and grotesque inspired boxy letter form.

---

<FullImage
  src="/img/pivot/application-social.webp"
  alt="Application - social media"
  caption="Art direction application on Instagram posts"
/>

<HalfImage
  src="/img/pivot/application-editorial-3.webp"
  alt="Application - social media"
  noPadding
/>

<HalfImage
  src="/img/pivot/application-editorial-2.webp"
...
<FullImage
  src="/img/pivot/application-editorial-1.webp"
  alt="Application - Editorial"
  noPadding
...
<ListLayout noPadding label="My Learnings">
  ...
  <ListItem>
    UX Deliverables need to involve its user in the creation process to be
    effective. Have to involve everyone on the team as soon as possible and make
    sure to provide the member enough (but not too much) context to work with.
  </ListItem>
</ListLayout>
...
-- With the help of an expanded team, I decided to map out the user journey. This helped our team to accumulate a shared understanding of the visitors' scenario, identifying opportunities in design and strategising the copy.
...
<ListLayout noPadding label="User Journey Focus" full>
  <ListItem heading="1. State of incoming visitors">
    Coming from instagram link, visitors already show a certain level of
    interest/knowledge about Pivot when they arrive at the website. HMW provide
...
To ensure the copy is concise and impactful at the moment, this time, I facilitated a remote sticky note session with the team copywriters and designers.
We devised a content strategy based on the research insights and the value the competition promised to provide.

<FullImage
  src="/img/pivot/content-planning.webp"
...
<FullImage src="/img/pivot/web-landing.webp" alt="landing page" />

##### Landing on the website

-> Apply CTA button on the top right corner allows returning visitors to quickly jump right to fill in the registration form, while first-time visitors who would like to learn about the competition can scroll down. (Unfortunately because of time constraint, the glitching colour strips weren't able to finish before the website release)

<FullImage src="/img/pivot/web-pitch.webp" alt="Pitch" />

##### Persona Targeted Pitch

-> Copy was crafted to put emphasis on growth opportunities and credibility of the competition.

<FullImage src="/img/pivot/web-facebook.webp" alt="connecting to facebook" />
...
<FullImage src="/img/pivot/handoff-specification.webp" />
