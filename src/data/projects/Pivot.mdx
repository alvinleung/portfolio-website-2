...
## 06 Outcome — Art Direction Applications
...
<ListLayout noPadding label="User Journey Insights" full>
  <ListItem heading="State of incoming visitors">
    ...
    when they arrive the website. HMW provide fresh content at that stage so
    that Alex can see the value of pivot and his concerns will be addressed?
  </ListItem>
  ...
  <ListItem heading="Pain Point: Re-visiting Website for Signup">
    ...
    registration tool already decided (we can't redesign the flow), HMW ustilise
    ui design to alleviate this painpoint in the website?
  </ListItem>
</ListLayout>
...
<ListLayout noPadding label="Content Strategy">
  <ListItem>
    <em>Growth</em> is what attracts competitors to Pivot
  </ListItem>
  <ListItem>
...
<FullImage
  ...
  caption="Remote content strategy session"
  noPadding
/>

---

## 11 The Web Experience ⁠— Interaction Design
