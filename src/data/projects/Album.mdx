---
slug: "/projects/album"
title: Meloncholic Nights in May
catagory: "Visual Identity"
weight: 5
tag: "visual-design"
tagline: Single album cover design for a cantonese low-fi hip-hop inspired track.
cover: /img/album-cover.jpg
description: Single album cover design for a cantonese low-fi hip-hop inspired track.
---

## 01 Overview

-- A pro bono album design project for a cantonese low-fi hip-hop inspired track. The track captures the moment of the songwriter succumbing to his emotion at a quiet summer night.
...
-- Inspired by the track itself, the cover art direction visually explores the juxtoposition of the hypnotic, soothing sound of low-fi hip-hop and the grievous theme of depression with colours and textures.
...
-> Occasional punctuation of faint but intense red marks was intended to heighten the raw emotion in the Jackson Pollock style painting, depicting the moment of sadness piercing through the quiet night.
