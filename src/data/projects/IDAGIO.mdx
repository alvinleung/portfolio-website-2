...
## 03 Why we focus on music discovery? A tale of two experiences

-- IDAGIO's indecisiveness in targeting an audience, has created created a fragmented experience between aficionado and new comer.

While the mood-ring is appreciated for the genre's new comers, our research suggest that aficionado tend to find the interaction "gimmicky" as it lack nuance, and don't find much use out of it.
...
-- Through a the _embed player_ and _browser extension_, iDAGIO engage their potential user in the awareness and consideration phase of the customer journey. These helpful, non-intrusive touchpoints build positive relationship with listeners, increasing their trust and, subsequently, likelihood of subscription to the service.
