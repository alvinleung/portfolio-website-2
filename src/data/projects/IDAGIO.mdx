...
<VideoPlayer
  src="https://www.sfu.ca/~kkl64/videos/idagio/	idagio-walkthrough-light.mp4"
  autoPlay
  hasSound
  caption="Concept Walkthrough"
/>
...
-- iDAGIO is a streaming service developed specifically for classical music. By providing an extensive library and methods of discovering new music within it, IDAGIO intends to establish itself as “the [digital] home for classical music", in order to _secure its future_.
...
#### Discovery generally happens socially, outside of streaming app
...
#### Listeners don’t trust generated playlist, they trust human

Multiple interviewees have mentioned that algorithmically generated playlist is off-putting because the system doesn’t understand the genre and their taste well enough, unlike their peers in forums.

--

#### No current solution for saving interesting discovery

Multiple interviewees have reported that they often have to hunt down the music again after their initial encounter, or worse, the discovery being lost forever.

--

#### Repeated exposure develops preference to new music

According to a [controlled experiement](https://journals.sagepub.com/doi/full/10.1177/0305735620987299) published on _Psychology of Music Journel_, the process of discovering new music is not necessarily love at first sight, preference develops over time as they familiarise with the sound. Especially when the user is new to the genre.
...
<VideoPlayer
  src="https://www.sfu.ca/~kkl64/videos/idagio/iteration-1.mp4"
...
#### Browser Extension: Highlights & Sidebar
