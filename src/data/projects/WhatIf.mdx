...
On the exhibit page, <InterfaceAnnotation timecode={6000} position={{ x: 960, y: 540 }}>resistive scrolling</InterfaceAnnotation> connects one exhibition article to another. Working with the user expectation of scrolling on websites, it subtly draws attention to a page turn at the end of an exhibit article.
...
>
  ...
  the content layout. As the visitor{" "}
