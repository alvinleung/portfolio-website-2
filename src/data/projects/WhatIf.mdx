...
weight: 1
tag: "featured"
tagline: Expressive post-event microsite for a bold speculative art exhibition
cover: /img/whatif-cover.webp
description: Expressive post-event microsite for a bold speculative art exhibition
hidden: false
---

## 01 Overview

-- This senior art direction + interaction design project envision an expressive post-event microsite for _what if?_ — an exhibition hosted by [Fabrica](https://www.fabrica.it/). Featuring interactive art installations from 12 international artists at the end of their art residency, the works capture daring speculations of humanity's future.
...
On the exhibit page, <InterfaceAnnotation timecode={6000} position={{ x: 960, y: 540 }}>resistive scrolling</InterfaceAnnotation> connects one exhibition article to another. Working with the user expectation of scrolling on websites, it subtly draw attention to a page turn at the end of an exhibit article.
