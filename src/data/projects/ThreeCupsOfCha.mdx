...
-> Over 90 concepts were generated during the ideaiton session.
...
-> After a feedback session with the clients, we decided to move on with concept 1. I further refined the the logo by added a chamfer to the edges to bring more wramth the design, making it look more friendly and welcoming.
